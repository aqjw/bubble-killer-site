...
def find_dividers(img, height_threshold=1.1, color_tolerance=1.5, resize_width=20, with_visual = True):
    ...
    # Draw dividers
    visual = draw_dividers(img, dividers) if with_visual else None
